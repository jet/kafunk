### 0.0.32-alpha001 - 24.02.2017

* Fix bug in ConsumerInfo module where offset information for all partitions wouldn't be combined and would throw during the merge.
